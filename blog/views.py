        ...
        if form.is_valid():
            if form.data['lieu'] == 'mangeoire':
                if mangeoire.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': "Désolé, le mangeoire est occupé"})
                    ...
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé {animal} n'est pas affamé"})

            elif form.data['lieu'] == 'roue':
                if roue.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé, la roue est occupé"})            
                    ...
                    if ancien_lieu!= litière:
                        ...
                        ancien_lieu.save()
                        form.save(commit=False)
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé {animal} n'est pas repus"})

            elif form.data['lieu'] == 'nid':
                if nid.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé, le nid est occupé"})            
                    ...
                    if ancien_lieu!= litière:
                        ...
                        ancien_lieu.save()
                        form.save(commit=False)
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé {animal} n'est pas fatigué"})

            elif form.data['lieu'] == 'litière':
                if litière.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé, la litière est occupé"})              
                    ...
                    if ancien_lieu!= litière:
                        ...
                        ancien_lieu.save()
                        form.save(commit=False)
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé {animal} n'est pas endormis"})
